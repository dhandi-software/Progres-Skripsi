...
// Category mapping (adjust IDs based on your backend)
const CATEGORIES = [
    { id: 1, name: "Nickel" },
    { id: 2, name: "Mining" },
    { id: 3, name: "Video" },
    { id: 4, name: "Market & Investment" },
    { id: 5, name: "Technology" },
    { id: 6, name: "Exclusive Interview" },
];

export function NewsSection() {
    const [date, setDate] = useState<Date | undefined>(new Date(2025, 0, 26));
        ...
        <div className="max-w-[60rem] mx-auto flex flex-col gap-[2rem]">
            ...
            {news.map((article) => (
                <CardNews
                    ...
                    title={article.title}
                    boldTitle
                    imageSrc={article.media?.path || "/images/ic_hero_image.jpg"}
