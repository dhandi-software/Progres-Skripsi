...
import { useMiningPage } from "./UseMiningPage";
...
export function MiningMobile() {
  ...
  const policiesData = news.slice(1, 5);  // Policies & Regulations
  const moreFromMiningData = news.slice(5, 9);  // More From Mining
  ...
  return (
    <main className="flex flex-col gap-6 pb-[3.75rem] pt-4 px-4">
      ...
      <div className="w-full">
        <SectionHeaderMobile title="Policies & Regulations" />
        <div className="flex flex-col gap-6">
          {policiesData[0] && <FeaturedCardMobile article={policiesData[0]} />}
      ...
      {/* More From Mining Section */}
      <div className="w-full">
        <SectionHeaderMobile title="More From Mining" />
        <div className="flex flex-col gap-6">
          {moreFromMiningData[0] && <FeaturedCardMobile article={moreFromMiningData[0]} />}
          {moreFromMiningData.slice(1).map((article) => (
            <RegularCardMobile key={article.id} article={article} />
          ))}
        </div>
      </div>
