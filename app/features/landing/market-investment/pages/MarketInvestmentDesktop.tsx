...
export function MarketInvestmentDesktop() {
  const {
    news,
    loading,
    error
    ...
    <main className="mx-auto w-full max-w-[90rem] px-[3.75rem] pt-6 pb-[3.75rem] flex gap-6">
      ...
      <section className="flex-1 flex flex-col gap-6">
        ...
        <div className="w-full">
          <SectionHeaderDesktop title="Market Analysis" />
          <div className="flex flex-col gap-6">
            {marketAnalysisData[0] && <FeaturedCardDesktop article={marketAnalysisData[0]} />}
        ...
        <div className="w-full">
          <SectionHeaderDesktop title="More From Market & Investment" />
          <div className="flex flex-col gap-6">
            {moreFromMarketData[0] && <FeaturedCardDesktop article={moreFromMarketData[0]} />}
