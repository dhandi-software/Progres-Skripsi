    ...
    return (
        <section className="w-full py-20 px-4">
             <div className="container mx-auto rounded-3xl overflow-hidden relative min-h-[400px] flex items-center justify-center text-center bg-zinc-900">
                ...
                <div className="relative z-10 max-w-3xl px-6 py-16 space-y-8 flex flex-col items-center">
                    <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight font-['Plus_Jakarta_Sans']">
                        Siap Memulai Karir <br/> <span className="text-orange-500">Profesional</span> Anda?
                    </h2>
                    <p className="text-zinc-300 text-lg md:text-xl font-medium max-w-2xl">
                        Bergabunglah dengan ratusan mahasiswa lainnya yang telah sukses menyelesaikan Kerja Praktek dan terhubung dengan industri.
                    </p>
                    <Link 
                        to="/login"
