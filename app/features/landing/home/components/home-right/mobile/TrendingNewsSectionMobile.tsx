...
interface TrendingNewsSectionMobileProps {
    news: NewsListItem[];
    loading?: boolean;
    error?: string;
}

export function TrendingNewsSectionMobile({
    news,
    loading,
    error,
}: TrendingNewsSectionMobileProps) {
    if (loading) {
        return (
    ...
    return (
        <section className="w-full">
            ...
            <div className="flex flex-col gap-[2rem] mt-[2rem] px-4">
                {news.map((article, i) => (
