...
interface HirilizationSectionMobileProps {
  news: NewsListItem[];
}

export function HirilizationSectionMobile({ news }: HirilizationSectionMobileProps) {
  ...
  return (
    <section className="w-full">
      <div className="flex gap-sm mb-lg text-[#D94F24] mt-xl">
        <h1 className="text-subheading-h5">Hirilization</h1>
      </div>
