...
interface PoliciesRegulationSectionMobileProps {
    news: NewsListItem[];
}

export function PoliciesRegulationSectionMobile({ news }: PoliciesRegulationSectionMobileProps) {
    ...
    return (
        <section className="w-full">
            <div className="flex gap-sm mb-lg text-[#D94F24] mt-xl">
                <h1 className="text-subheading-h5">Policies & Regulation</h1>
            </div>
