...
export function NickelMobile() {
    ...
    return (
        <main className="flex flex-col gap-6 pb-[3.75rem] pt-4 px-4">
            ...
            <div className="w-full">
                <SectionHeaderMobile title="Hirilization" />
                <div className="flex flex-col gap-6">
                    {hirilizationData[0] && <FeaturedCardMobile article={hirilizationData[0]} />}
            ...
            <div className="w-full">
                <SectionHeaderMobile title="More From Nickel" />
                <div className="flex flex-col gap-6">
                    {moreFromNickelData[0] && <FeaturedCardMobile article={moreFromNickelData[0]} />}
                    <AdvertisementMobile />
