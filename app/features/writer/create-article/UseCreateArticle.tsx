...
export const useCreateArticle = (options: UseCreateArticleOptions = {}) => {
    ...
    if (articleId && isEditMode) {
      const fetchArticle = async () => {
        ...
        try {
          ...
          setIsHeadline(article.set_headline === true || article.setHeadline === true);
          ...
          if (article.media) {
            ...
            console.log("Setting selected image:", { id: article.media.id, name: mediaName, url: mediaUrl });
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      setTimeout(() => navigate("/writer/draft"), 1500);
    } catch (error) {
