...
import { MediaDesktop } from "~/features/writer/media";
import PopupAdvertisementDesktop from "~/features/writer/popup-advertisement/PopupAdvertisementDesktop";
import PreviewDesktop from "./components/PreviewDesktop";
import { DeleteArticlePopup } from "~/features/writer/draft/components";
    ...
    <div className="w-full min-h-screen bg-white px-[1.5rem] pt-[1.5rem] pb-[3.75rem]">
      ...
      <div className="w-full flex flex-col gap-[0.75rem] mb-[1.5rem]">
        <h1 className="text-[1.875rem] font-semibold text-[#0D0D12] leading-[2.25rem]">
          {states.isEditMode ? "Edit Article" : "Create a News"}
        </h1>
        <p className="text-[0.875rem] text-[#71717A] leading-[1.25rem]">
          {states.isEditMode
            ? "Modify the details below to update your news article."
