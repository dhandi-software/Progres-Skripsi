    ...
    return (
        <div className="fixed inset-0 z-[200] bg-white flex flex-col animate-in slide-in-from-bottom duration-300">
            ...
            <div className="flex-1 overflow-y-auto bg-gray-50/30">
                ...
                {!isApprovedReadOnly && (
                    <div className="bg-white border-t border-gray-100 flex flex-col shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.05)] relative z-20">
                        {/* Drag Handle & Tabs */}
                        <div className="bg-white rounded-t-3xl border-b border-gray-100">
                            <div className="w-12 h-1.5 bg-gray-200 rounded-full mx-auto my-3"></div>
                            <div className="flex px-4">
                                <button
                                    onClick={() => setActiveTab('review')}
                                    className={`flex-1 py-3 text-sm font-bold text-center border-b-2 transition-all ${activeTab === 'review' ? 'border-[#119DA4] text-[#119DA4]' : 'border-transparent text-gray-500 hover:bg-gray-50'}`}
                                >
                                    Form Keputusan
                                </button>
                                <button
                                    onClick={() => setActiveTab('history')}
                                    className={`flex-1 py-3 text-sm font-bold text-center border-b-2 transition-all flex items-center justify-center gap-1.5 ${activeTab === 'history' ? 'border-orange-500 text-orange-600' : 'border-transparent text-gray-500 hover:bg-gray-50'}`}
                                >
                                    Riwayat Anotasi
                                    {previousAnnotations.length > 0 && (
                                        <span className="px-1.5 py-0.5 rounded-md bg-orange-100 text-orange-600 text-[9px]">
                        ...
                        <div className="p-6 bg-white overflow-y-auto max-h-[50vh] min-h-[30vh]">
                            {activeTab === 'review' ? (
