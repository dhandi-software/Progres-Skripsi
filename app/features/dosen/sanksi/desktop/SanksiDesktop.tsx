...
import type { SanksiAdministrasi, SupervisedStudent, SanksiFormState } from "~/api/types";

export type { SanksiAdministrasi, SupervisedStudent, SanksiFormState as FormState };
