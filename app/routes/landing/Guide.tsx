...
export default function GuidePage() {
    return (
        <div className="container mx-auto py-12 px-4 max-w-7xl">
            ...
            <h1 className="text-3xl font-bold mb-8 text-foreground">Panduan Kerja Praktek</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                    ...
                    <Card key={i} className="group hover:border-orange-200 hover:shadow-lg transition-all duration-300">
                        <CardHeader className="flex flex-row items-center gap-4 pb-2">
                            ...
                            <div>
                                <span className="text-xs font-bold text-orange-500 uppercase tracking-wider">Langkah {item.step}</span>
                                <CardTitle className="text-xl text-zinc-900 group-hover:text-orange-700 transition-colors">{item.title}</CardTitle>
                            </div>
                        </CardHeader>
                        <CardContent>
                            ...
                            <Button variant="ghost" className="w-full justify-between hover:bg-orange-50 text-slate-700 group-hover:text-orange-700">
